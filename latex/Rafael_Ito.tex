...
\begin{cvtable}[1.5]
	...
	\cvitem
        ...
        {blabljdbjsdl bksdjblsdblds bjsd bkljsd blksjd blksdj blsd jblsd blksdjb lksdj blkds jblskd bjsdbjksdl bjlsdjblsd jblsdb sdlk bjlds jbsdkl bdsjl bkldsj blsd lbj s dblsdb sd kbj sdlkbjdskl bjdskl jbldsj bb\medskip}
    %---------------------------------------
    \cvdivider
    %---------------------------------------
	...
	\cvitem
        ...
        {Bamboo Broker}
        {Stock Exchange}
        {Continuously achieving better bamboo bangs for the buck.}
    %---------------------------------------
\end{cvtable}
...
\begin{cvtable}[1.5]
	\cvitem
        ...
        {Graduate}
        {University of Campinas}
        {Part-time Masters degree.\medskip}
    %---------------------------------------
    \cvdivider
    %---------------------------------------
	\cvitem
    ...
    \cvitem
        ...
        {Queen Mary University of London}
        {Studies sponsored by the Brazilian government due to academic merit. Science without Borders (SwB) student exchange program.\medskip}
    %---------------------------------------
    \cvdivider
    %---------------------------------------
	\cvitem
        ...
        {Selected to work as a Teaching Assistant of the technical course.\medskip}
    %---------------------------------------
\end{cvtable}
